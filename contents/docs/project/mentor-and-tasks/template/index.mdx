...
<Stepper>
  <StepperItem title="第一步：进入项目设置">
    ...
    <img src="/images/project/mentor-and-tasks/template/issue_template-1.jpg" />
  </StepperItem>
  <StepperItem title="第二步：设置模版">
    找到Issue部分，点击Set up templates
    <img src="/images/project/mentor-and-tasks/template/issue_template-2.jpg" />
  </StepperItem>
  <StepperItem title="第三步：自定义模版内容">
    选择自定义模版内容，输入以下模版示例中的例子，根据需要添加自定义标题和标签
    <img src="/images/project/mentor-and-tasks/template/issue_template-3.jpg" />
  </StepperItem>
  <StepperItem title="第四步：提交自定义模版">
    <img src="/images/project/mentor-and-tasks/template/issue_template-4.jpg" />
  </StepperItem>
  <StepperItem title="第五步：新建Issue">
    在Issue tab下新建Issue，查看刚才添加的模版是否正确
    <img src="/images/project/mentor-and-tasks/template/issue_template-5.jpg" />
  </StepperItem>
</Stepper>
