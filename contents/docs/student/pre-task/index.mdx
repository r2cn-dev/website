...
<Note type="success" title="测试任务类型">
    1. 通过 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 和 Git 对比，找到缺失的特性并完成，完善 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 的功能；
    2. 增加 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 测试用例，提升 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 质量；
    3. 开源社区存在很多 Git 增强功能的程序，分析这些程序的功能，为 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 增加新的命令和功能；
    4. 可自行设计 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 特性， 为 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 增加新的命令和功能，或者测试出一个 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 的 __Bug__ ，修复 __Bug__ 也可以作为测试任务；
</Note>
...
1. 当然也可以根据使用 Git 的经验，自行设计新的功能。请充分发挥自己的想象力，[Mega](https://github.com/web3infra-foundation/mega) 项目不会拒绝任何有创意的功能；
2. 或者测试出一个 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 的 __Bug__ ，修复 __Bug__ 也可以作为测试任务。

#### 5. 联系方式

1. 如果对自行设计新功能，或对测试任务有疑问，可以和 [@genedna](https://github.com/genedna) 联系，讨论请发送邮件到 `eli@patch.sh` ；
2. 或在 [论坛](https://github.com/orgs/r2cn-dev/discussions) 发起讨论 ；
3. 或在 [R2CN Discord](https://discord.gg/WRp4TKv6rh) 的 `#pretask` 频道发起讨论；
...
<Stepper>
  <StepperItem title="第一步：创建测试任务 Issue">
      ...
      也可以在 [Mega](https://github.com/web3infra-foundation/mega) 的 [r2cn](https://github.com/orgs/web3infra-foundation/projects/2) 项目中查看已经完成的任务和正在进行的任务；
