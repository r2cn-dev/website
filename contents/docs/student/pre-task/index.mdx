...
<Note type="success" title="测试任务类型">
    ...
    4. 可自行设计 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 特性， 为 [libra](https://github.com/web3infra-foundation/mega/tree/main/libra) 增加新的命令和功能；
</Note>
...
当然也可以根据使用 Git 的经验，自行设计新的功能。请充分发挥自己的想象力，[Mega](https://github.com/web3infra-foundation/mega) 项目不会拒绝任何有创意的功能。
