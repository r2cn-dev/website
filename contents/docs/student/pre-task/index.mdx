...
<Stepper>
  ...
  <StepperItem title="第五步：关闭 Issue">
    当 [Mega](https://github.com/web3infra-foundation/mega) 项目维护者认为 PR 已经完成测试任务，会将 Issue 的 **Projects** **r2cn** 的 **Status** 设为 **Done** 。此时同学可以使用此 Issue 的链接，作为注册 r2cn 提交的测试任务链接。
