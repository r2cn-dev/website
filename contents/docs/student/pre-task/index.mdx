...
如果对自行设计新功能，或对测试任务有疑问，可以和 [@genedna](https://github.com/genedna) 联系，如需讨论请发送邮件到 `eli@patch.sh` ，也可在 [论坛](https://github.com/orgs/r2cn-dev/discussions) 或 [R2CN Discord](https://discord.gg/WRp4TKv6rh) 的 `#pretask` 频道发起讨论。
